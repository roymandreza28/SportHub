...
export function OrganizerPage() {
  ...
  return (
    <DashboardShell navItems={NAV_ITEMS}>
      ...
      <Section id="news" title="News" description="Publish an update for the community.">
        <NewsEditor />
        <div className="mt-4 border-t border-slate-100 pt-4">
          <NewsFeed />
        </div>
      ...
      <Section id="livestreams" title="Livestreams" description="Start a livestream tied to a tournament.">
