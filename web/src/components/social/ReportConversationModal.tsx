...
import { reportConversation } from '../../lib/chatApi'
import { buttonPrimary, buttonSecondary, textarea } from '../../lib/formStyles'
import { IconX } from '../layout/icons'

// Posts straight into the caller's own "Contact admin" support thread (see
// ConversationController::report()) — there's no separate admin moderation
// inbox in this app, so that existing thread is the only place a report
// actually reaches a human today.
export function ReportConversationModal({ conversationId, onClose }: { conversationId: number; onClose: () => void }) {
        ...
        {submitted ? (
          <>
            ...
            <p className="mt-2 text-sm text-slate-600">
              Thanks — our support team will review this conversation and follow up in your admin chat thread if needed.
            </p>
          ...
          <>
            <div className="flex items-start justify-between gap-3">
              <h2 className="text-lg font-bold text-slate-900">Report this conversation</h2>
