...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE tournaments ADD CONSTRAINT tournaments_format_check CHECK (format IN ('single_elimination', 'double_elimination', 'round_robin', 'group_stage', 'swiss'))");
    }
